...
class NeuroscienceSpider(SitemapSpider):
    name = "neuroscience"
    
    def __init__(self):
        with open(f'/Users/santiagosaldivar/Coding/govGlaceCrawler/src/crawl/crawl/websites_to_index/{NeuroscienceSpider.name}.json', encoding = 'utf-8') as data_file:
