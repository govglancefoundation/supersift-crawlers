...
class QuantumComputingSpider(SitemapSpider):
    name = "quantum_computing"

    def __init__(self):
        with open(f'/Users/santiagosaldivar/Coding/govGlaceCrawler/src/crawl/crawl/websites_to_index/{QuantumComputingSpider.name}.json', encoding = 'utf-8') as data_file:
