...
class GeneralResearchInstitutesSpider(SitemapSpider):
    name = "general_research_institutes"

    def __init__(self):
        with open(f'/Users/santiagosaldivar/Coding/govGlaceCrawler/src/crawl/crawl/websites_to_index/{GeneralResearchInstitutesSpider.name}.json', encoding = 'utf-8') as data_file:
