...
class ArtMuseumsSpider(SitemapSpider):
    name = "art_museums"

    def __init__(self):
        with open(f'/Users/santiagosaldivar/Coding/govGlaceCrawler/src/crawl/crawl/websites_to_index/{ArtMuseumsSpider.name}.json', encoding = 'utf-8') as data_file:
