...
class NaturalHistoryMuseumsSpider(SitemapSpider):
    name = "natural_history_museums"
    
    def __init__(self):
        with open(f'/Users/santiagosaldivar/Coding/govGlaceCrawler/src/crawl/crawl/websites_to_index/{NaturalHistoryMuseumsSpider.name}.json', encoding = 'utf-8') as data_file:
