...
class ScientificJournalsSpider(SitemapSpider):
    name = "scientific_journals"
    
    def __init__(self):
        with open(f'/Users/santiagosaldivar/Coding/govGlaceCrawler/src/crawl/crawl/websites_to_index/{ScientificJournalsSpider.name}.json', encoding = 'utf-8') as data_file:
