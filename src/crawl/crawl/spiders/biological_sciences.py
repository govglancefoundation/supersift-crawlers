...
class BiologicalSciencesSpider(scrapy.Spider):
    name = "biological_sciences"
    
    def __init__(self):
        with open(f'/Users/santiagosaldivar/Coding/govGlaceCrawler/src/crawl/crawl/websites_to_index/{BiologicalSciencesSpider.name}.json', encoding = 'utf-8') as data_file:
